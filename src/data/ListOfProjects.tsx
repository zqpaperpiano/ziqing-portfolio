...
export const ListOfProjects: ProjectDetails[] = [
    {
        ...
        moreDetails: (
            <>
            <h1 className="text-white text-sm font-medium py-1">Overview</h1><hr className="p-1" />
            ...
            <h1 className="text-white text-sm font-medium py-1 mt-2">Tech Stack</h1><hr className="p-1" />
            ...
            <h1 className="text-white text-sm font-medium py-1 mt-2">Features</h1><hr className="p-1" />
            <li>User Authentication</li>
            <li>Dynamic Routing with React Router</li>
            <li>API Integration with Firebase</li>

            <h1 className="text-white text-sm font-medium py-1 mt-2">Future Improvements</h1><hr className="p-1" />
